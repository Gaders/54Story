<template>
    <div class="background">
        ...
        <div class="buttonOK" v-if="StoryNum[currentPage] == 1">
        </div>
...
import storyInfo from '../components/story/storyInfo3'
        ...
        toGetCard() {
            if(this.time == -1) {
                ...
                if(this.currentPage == 4) {
                    updataCard(3, this.currentPage + 1, this.cardId) 
                    this.StoryNum[this.currentPage] = 1
                    return
                }
                this.cardId = this.currentPage +  1
                updataCard(3, this.currentPage + 1, this.currentPage + 1) 
                this.StoryNum[this.currentPage] = 1
            }  
        },
        timing() {
...
.buttonOK {
    ...
    height: 106px;
    background-size: 100% 100%;
    background-image: url(../assets/imgs/story/buttonOK.png);
}
.afterGetCard {
    font-family: 'huakang';
